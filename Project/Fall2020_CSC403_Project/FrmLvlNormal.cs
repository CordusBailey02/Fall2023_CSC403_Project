...
{
    public partial class FrmLvlNormal : Form
    {
        ...
        public FrmLvlNormal(FrmInventory inv)
        {
            ...
            //Add the controls from the room to the frm...
            drawRoom(curRoom);
        ...
        private void FrmLvlNormal_Load(object sender, EventArgs e)
        {
        ...
        private void FrmLvlNormal_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void FrmLvlNormal_KeyDown(object sender, KeyEventArgs e)
        {
