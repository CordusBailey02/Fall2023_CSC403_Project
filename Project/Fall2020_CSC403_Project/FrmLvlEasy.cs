...
{
    public partial class FrmLvlEasy : Form
    {
        ...
        public FrmLvlEasy(FrmInventory inv)
        {
            this.inventory = inv;
        ...
        private void FrmLvlEasy_Load(object sender, EventArgs e)
        {
        ...
        private void FrmLvlEasy_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void tmrPlayerMove_Tick(object sender, EventArgs e)
        {
            ...
            // Handles Hitting the border walls
            ...
            else if((doors.Length > 0 && doors[0] != null) && HitADoor(player))
            {
                switch(doorsP[collDoorIndex].Name)
                {
                    ...
                    case "toR5FromR2":
                        //logic
                        Console.WriteLine("Opened Door In Room 2... Entering Room 4");
                    ...
                    case "toR4FromR3":
                        //logic
                        Console.WriteLine("Opened Door In Room 3... Entering Room 5");
        ...
        private void FrmLvlEasy_KeyDown(object sender, KeyEventArgs e)
        {
